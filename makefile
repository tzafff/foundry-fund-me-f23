...
#--rpc-url $(SEPOLIA_RPC_URL) --account sepoliaKey --sender 0x1678FB9b230722A79fFcA6DB3b11B8c3Ca18Ab9e #--password-file .password  --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
